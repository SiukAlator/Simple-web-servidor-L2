		...
		<center>
			...
			<div class="cuerpo" >
				...
				<div align="left" style="margin-left: 2cm; margin-right: 2cm;">
					...
					<form action="recuperar_pass2.php" method="POST" id="recuperar_pass2">
						<table style=" margin-left: 5cm;">
							...
							<tr>
								...
								<td>
								<div align="right">
								<input class="form-btn" name="submit1" type="submit" value="Guardar" />
								</div>
								</td>
							</tr>
						</table>
